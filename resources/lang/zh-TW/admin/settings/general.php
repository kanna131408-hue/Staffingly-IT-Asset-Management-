...
return [
    ...
    'login_remote_user_custom_logout_url_help' => '如果此處提供了 URL，則在用戶登出 Staffingly 後，用戶將被重定向到此 URL。這對於正確關閉身份驗證提供程序非常有用。',
    ...
    'show_images_in_email_help'   => '如果您的Staffingly安裝位於VPN或封閉網絡後面，並且外部網絡的用戶無法將通過此安裝提供的圖像加載到其電子郵件中，請取消選中此框。',
    'site_name'                 => '站台名稱',
    'integrations'               => '整合',
    'slack'                     => 'Slack',
    ...
    'snipe_version'  			=> 'Staffingly 版本',
    'support_footer'            => '支援頁尾連結',
    'support_footer_help'       => '指定誰可以看到指向Staffingly支持信息和用戶手冊的鏈接',
    'version_footer'            => '頁尾版本 ',
    'version_footer_help'       => '指定誰可以看到Staffingly版本和內部版本號。',
    'system'                    => '系統資訊',
    'update'                    => '更新設定',
    'value'                     => '價值',
    'brand'                     => '企業識別',
    ...
    'width_w'        => '寬',
    'height_h'        => '高',
    'show_url_in_emails'                => '鏈接到Staffingly在電子郵件',
    'show_url_in_emails_help_text'      => '如果您不希望鏈接回電子郵件頁腳中的Staffingly安裝，請取消選中此框。如果您的大多數用戶從未登錄，則很有用',
    'text_pt'        => '磅',
    ...
    'barcodes_help' => '這將嘗試刪除快取的條碼。這通常只在您的條碼設定已更改，或者您的 Staffingly 網址已更改時使用。條碼將在下次存取時重新產生。',
