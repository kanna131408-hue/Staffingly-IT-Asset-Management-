...
return [
    ...
    'importing_help'        => 'Il CSV deve essere delimitato da virgole e formattato con intestazioni che corrispondono a quelle presenti nei <a href="https://staffingly.readme.io/docs/importing" target="_new">CSV di esempio nella documentazione <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg'        => 'Ciao! Sembra che l\'integrazione di :app su Staffingly funzioni!',
...
<p>Per esportare solamente alcune risorse, utilizzare le opzioni che seguono per filtrare i risultati.</p>',
    ...
    'footer_credit' => '<a target="_blank" href="https://staffinglyapp.com" rel="noopener">Staffingly</a>è un software open source, realizzato con <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">amore</span> da Grokability, Inc.',
