...
return [
    ...
    'login' => 'Είσοδος',
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση Staffingly χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    ...
    'serial' => 'Σειριακός',
    'snipe_webhook_test' => 'Staffingly Δοκιμή Ολοκλήρωσης',
    'snipe_webhook_summary' => 'Σύνοψη Δοκιμής Ενσωμάτωσης Staffingly',
    'supplier' => 'Προμηθευτές',
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για Staffingly',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της Staffingly. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας Staffingly',
