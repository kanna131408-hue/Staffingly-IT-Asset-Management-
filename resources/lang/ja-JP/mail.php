...
return [
    ...
    'login' => 'ログイン',
    'login_first_admin' => '以下の新しいログイン情報を使用して、Staffinglyにログインします。',
    ...
    'serial' => 'シリアル',
    'snipe_webhook_test' => 'Staffingly 統合テスト',
    'snipe_webhook_summary' => 'Staffingly 統合テストの概要',
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'Staffinglyからのテストメール',
    'test_mail_text' => 'これはStaffingly資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'Staffingly クレデンシャル',
