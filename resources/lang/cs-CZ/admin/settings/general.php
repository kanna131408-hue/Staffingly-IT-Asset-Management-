...
Tím zabráníte systému Staffingly v pokusu načítat avatary z Gravataru nebo jiných externích zdrojů.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Pokud je zde uvedena adresa URL, uživatelé budou po odhlášení ze Staffingly přesměrování na tuto URL. To je užitečné pro správné ukončení relací Authentication providera.',
    ...
    'show_images_in_email_help'   => 'Zrušte zaškrtnutí této kolonky, pokud je instalace Staffingly za VPN nebo uzavřenou sítí a uživatelé mimo síť nebudou moci do svých e-mailů načíst obrázky z této instalace.',
    ...
    'snipe_version'  			=> 'Verze Staffingly',
    'support_footer'            => 'Odkazy v zápatí na podporu ',
    'support_footer_help'       => 'Určete, kdo uvidí odkazy na Staffingly podporu a uživatelskou příručku',
    'version_footer'            => 'Verze v zápatí ',
    'version_footer_help'       => 'Určete kdo uvidí verzi Staffingly a číslo sestavení.',
    ...
    'width_w'        => 'š',
    'height_h'        => 'v',
    'show_url_in_emails'                => 'Odkaz na Staffingly v e-mailech',
    'show_url_in_emails_help_text'      => 'Zrušte zaškrtnutí tohoto políčka, pokud nechcete odkazovat zpět na instalaci Staffingly do vašich emailových patek. Užitečné, pokud se většina vašich uživatelů nikdy nepřihlásí.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Toto se pokusí odstranit čárové kódy v mezipaměti. Obvykle se používá v případě, kdy došlo ke změně nastavení čárového kódu nebo v případě, že se změnila URL adresa Staffingly. Kódy budou vygenerovány znovu.',
