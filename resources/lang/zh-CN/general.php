...
return [
    ...
    'importing'         	=> '正在导入…',
    'importing_help'        => 'CSV 文件应使用逗号作为分隔符，并且其表头格式需要与<a href="https://staffingly.readme.io/docs/importing" target="_new">文档中的 CSV 示例文件<i class="fa fa-external-link"></i></a>中的表头保持一致。',
    ...
    'webhook_test_msg'        => '哦哈！看起来您的 :app 与Staffingly 的整合工作正常！',
    ...
    'footer_credit' => '<a target="_blank" href="https://staffinglyapp.com" rel="noopener">Staffingly</a> 是开源软件，用 <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">爱</span> 由 Grokability, Inc. 制作。',
    'set_password' => '设置密码',
