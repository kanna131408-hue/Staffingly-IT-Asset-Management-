...
return [
    ...
    'link_light_color_help'     => 'Selecciona un color que proporcione suficiente contraste para las personas que utilicen Staffingly en modo Claro.',
    ...
    'ldap_display_name_help'    => 'Si tiene un campo displayName separado en su LDAP/AD, lo mapeará aquí y se utilizará para mostrar usuarios dentro de Staffingly.',
    ...
    'load_remote_help_text'		=> 'Desmarque esta casilla si su instalación no puede cargar secuencias de comandos (scripts) desde Internet . Esto evitará que Staffingly intente cargar avatares de Gravatar u otras fuentes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una URL aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de Staffingly. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta casilla si su instalación de Staffingly está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes publicadas desde este servidor de Staffingly en sus correos electrónicos.',
    ...
    'snipe_version'  			=> 'Versión de Staffingly',
    'support_footer'            => 'Enlace al soporte en el pie de página ',
    'support_footer_help'       => 'Especifique quién puede ver los enlaces a la información de soporte de Staffingly y al manual de usuario.',
    'version_footer'            => 'Versión en el pie de página ',
    'version_footer_help'       => 'Especifique quién puede ver la versión de Staffingly y el número de compilación.',
    ...
    'width_w'        => 'ancho',
    'height_h'        => 'alto',
    'show_url_in_emails'                => 'Enlace a Staffingly en correos electrónicos',
    'show_url_in_emails_help_text'      => 'Desmarque esta casilla si no desea vincular su instalación de Staffingly en el pie de página de correo electrónico. Útil si la mayoría de sus usuarios nunca se conectan. ',
    'text_pt'        => 'puntos',
    ...
    'barcodes_help' => 'Esto intentará eliminar códigos de barras almacenados en caché. Normalmente solo se usa si la configuración del código de barras ha cambiado o si ha cambiado la URL de Staffingly. Los códigos de barras se volverán a generar la próxima vez que se acceda a ellos.',
