...
return [
    ...
    'importing_help'        => 'The CSV-файл повинен бути розділений комами та відформатований із заголовками, які відповідають тим, що наведені в <a href="https://staffingly.readme.io/docs/importing" target="_new">прикладах CSV у документації <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg'        => 'О, клас! Здається, що ваша інтеграція з Staffingly працює!',
    ...
    'footer_credit' => '<a target="_blank" href="https://staffinglyapp.com" rel="noopener">Staffingly</a> — це програмне забезпечення з відкритим вихідним кодом, створене з <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">любов\'ю</span> компанією Grokability, Inc.',
