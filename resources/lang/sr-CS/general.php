...
return [
    ...
    'importing'         	=> 'Uvoženje',
    'importing_help'        => 'CSV treba biti razdvojen zarezom i formatiran sa zaglavljima koji se poklapaju sa onima u <a href="https://staffingly.readme.io/docs/importing" target="_new">primerom CSV-a iz dokumentacije <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg'        => 'O zdravo! Izgleda da vaša :app integracija sa Staffingly radi!',
    ...
    'footer_credit' => '<a target="_blank" href="https://staffinglyapp.com" rel="noopener">Staffingly</a> je softver otvorenog koda, napravljen sa <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">ljubavlju</span> od strane Grokability, Inc.',
