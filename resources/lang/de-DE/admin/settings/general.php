...
return [
    ...
    'ldap_display_name_help'    => 'Wenn es ein separates <code>displayName</code> Attribut in Ihrem LDAP/AD gibt, dann können Sie es hier abbilden, womit dieses dann für die Darstellung der Benutzernamen in Staffingly verwendet wird.',
    ...
    'load_remote_help_text'		=> 'Deaktivieren Sie dieses Kästchen, wenn Ihre Installation keine Skripte aus dem externen Internet laden kann. Das verhindert, dass Staffingly versucht, Bilder von Gravatar oder anderen externen Quellen zu laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus Staffingly ausloggt. Dies ist nützlich, um die Benutzersitzung Ihres Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help'   => 'Deaktivieren Sie dieses Kontrollkästchen, wenn sich Ihre Staffingly-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihre E-Mails laden können.',
    ...
    'snipe_version'  			=> 'Staffingly Version',
    'support_footer'            => 'Fußzeile Support-Link ',
    'support_footer_help'       => 'Geben Sie an, wer die Links zum Staffingly Support-Info und Benutzerhandbuch sieht',
    'version_footer'            => 'Version in in der Fußzeile ',
    'version_footer_help'       => 'Spezifiert, wer die Version und Build-Nummer von Staffingly angezeigt bekommt.',
    ...
    'width_w'        => 'b',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link zu Staffingly in E-Mails',
    'show_url_in_emails_help_text'      => 'Deaktivieren Sie dieses Kontrollkästchen, wenn Sie in Ihren E-Mail-Fußzeilen keine Verbindung zu Ihrer Staffingly-Installation herstellen möchten. Nützlich, wenn die meisten Ihrer Benutzer sich nie einloggen.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Ihre Staffingly-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
    ...
    'label2_2d_target_help'   => 'Die Daten, die im 2D Barcode enthalten sein werden. Dies kann direkt mit dem Gegenstand in Staffingly verbinden oder einer der nicht verknüpften Feldwerte sein. Wenn Sie das Präfix oben verwenden, wird es diesem Wert vorangestellt.',
    ...
    'help_default_will_use' => 'Beachten Sie, dass der Wert der Barcodes mit der jeweiligen Barcode-Spezifikation übereinstimmen muss, um erfolgreich generiert zu werden. Bitte lesen Sie <a href="https://staffingly.readme.io/docs/barcodes">die Dokumentation <i class="fa fa-external-link"></i></a> für weitere Details. ',
    'asset_id'              => 'Asset-ID',
    'data'               => 'Daten',
    'default'               => 'Standard',
    'none'                  => 'Nichts',
