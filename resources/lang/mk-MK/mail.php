...
return [
    ...
    'login' => 'Најава',
    'login_first_admin' => 'Влезете во новата инсталација на Staffingly користејќи ги ингеренциите подолу:',
    ...
    'serial' => 'Сериски',
    'snipe_webhook_test' => 'Staffingly Тест за интеграција',
    'snipe_webhook_summary' => 'Staffingly Резиме на тест за интеграција',
    'supplier' => 'Добавувач',
    'tag' => 'Таг',
    'test_email' => 'Тест е-пошта од Staffingly',
    'test_mail_text' => 'Ова е тест од Staffingly Системот за управување со основни средства. Ако го добивте ова, е-поштата работи :)',
