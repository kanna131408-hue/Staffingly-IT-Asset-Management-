...
return [
    ...
    'ldap_activated_flag_help'  => '이 값은 동기화된 사용자가 Staffingly에 로그인할 수 있는지 여부를 결정하는 데 사용됩니다. <strong> 항목을 체크인하거나 체크아웃하는 기능에는 영향을 미치지 않으며, AD/LDAP 내에서 값이 아닌 <strong> 속성 이름이어야 합니다. <br><br>이 필드가 AD/LDAP에 없는 필드 이름으로 설정되거나 AD/LDAP 필드의 값이 <code>0/code> 또는 <code>false/code>로 설정된 경우, <strong> 사용자 로그인이 비활성화됩니다. AD/LDAP 필드의 값이 <code>1</code>, <code>true</code> 또는 다른 텍스트<em>로 설정되어 있으면 사용자가 로그인할 수 있습니다. AD에서 필드가 비어 있으면 일반적으로 일시 중단되지 않은 사용자가 로그인할 수 있는 <code>userAccountControl</code> 속성을 사용합니다.',
    ...
    'show_images_in_email_help'   => 'Staffingly 설치가 VPN 또는 폐쇄 형 네트워크 하에 있고 네트워크 외부 사용자가 이 설치에서 제공된 이미지를 이메일에 불러올수 없는 경우 이 상자의 선택을 해제하세요.',
    'site_name'                 => '사이트 명',
    ...
    'snipe_version'  			=> 'Staffingly 버전',
    'support_footer'            => '꼬리말 링크 지원',
    'support_footer_help'       => 'Staffingly 지원 정보 및 사용자 매뉴얼 보기 권한 설정',
    'version_footer'            => '바닥글에 버전 ',
    'version_footer_help'       => 'Staffingly 버전과 빌드 번호를 볼 수 있는 사용자를 지정합니다.',
    'system'                    => '시스템 정보',
    'update'                    => '갱신 설정',
    'value'                     => '가치',
    'brand'                     => '브랜딩',
    ...
    'width_w'        => '넓이',
    'height_h'        => '높이',
    'show_url_in_emails'                => 'Staffingly에 이메일로 링크',
    'show_url_in_emails_help_text'      => '전자 메일 바닥 글에 Staffingly 설치를 다시 연결하지 않으려면이 상자를 선택 취소하십시오. 대부분의 사용자가 로그인하지 않는 경우 유용합니다.',
    'text_pt'        => 'pt',
