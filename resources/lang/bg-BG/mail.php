...
return [
    ...
    'login' => 'Логин',
    'login_first_admin' => 'Влезте в своята Staffingly инсталация използвайки данните по-долу:',
    ...
    'snipe_webhook_test' => 'Staffingly Интеграционен тест',
    'snipe_webhook_summary' => 'Staffingly Резюме на интеграционния тест',
    'supplier' => 'Доставчик',
    'tag' => 'Етикет',
    'test_email' => 'Тест Email от Staffingly',
    'test_mail_text' => 'Това е тест от Staffingly система за управление на активи. Ако сте получили това, email-а работи :)',
    ...
    'your_credentials' => 'Вашите идентификационни данни за Staffingly',
