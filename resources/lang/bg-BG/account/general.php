...
return array(
    ...
    'api_reference' => 'Моля, проверете <a href="https://staffingly.readme.io/reference" target="_blank">справката за API</a>, за да намерите конкретни API крайни точки и допълнителна API документация.',
