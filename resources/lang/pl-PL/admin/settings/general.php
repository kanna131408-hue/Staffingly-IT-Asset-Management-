...
return [
    ...
    'load_remote_help_text'		=> 'Odznacz to pole, jeśli instalacja nie może załadować skryptów z zewnętrznego internetu. To uniemożliwi Staffingly próby załadowania obrazów z Gravatar.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Jeżeli URL jest tutaj wpisany, użytkownicy zostaną przekierowani do tego adresu URL po wylogowaniu ze Staffingly. Jest to przydatne do prawidłowego zamknięcia sesji użytkownika twojego dostawcy uwierzytelniania.',
    ...
    'show_images_in_email_help'   => 'Odznacz to pole, jeśli twoja instalacja Staffingly znajduje się za siecią VPN lub siecią zamkniętą, a użytkownicy spoza sieci nie będą mogli załadować obrazów obsługiwanych przez tę instalację w swoich wiadomościach e-mail.',
    ...
    'snipe_version'  			=> 'Wersja Staffingly',
    'support_footer'            => 'Obsługa linków stopki ',
    'support_footer_help'       => 'Określ kto widzi linki do Staffingly Instrukcji Obsługi oraz Wsparcia',
    'version_footer'            => 'Wersja w stopce ',
    'version_footer_help'       => 'Określ, kto widzi wersję oraz numer kompilacji Staffingly.',
    ...
    'width_w'        => 'szerokość',
    'height_h'        => 'wysokość',
    'show_url_in_emails'                => 'Połącz się z Staffingly w wiadomościach e-mail',
    'show_url_in_emails_help_text'      => 'Usuń zaznaczenie tego pola, jeśli nie chcesz łączyć się z instalacją Staffingly w stopkach wiadomości e-mail. Przydatne, jeśli większość użytkowników nigdy nie loguje się.',
    'text_pt'        => 'piksel',
    ...
    'barcodes_help' => 'Spowoduje to próbę usunięcia kodów kreskowych z pamięci podręcznej. Jest to zwykle używane tylko wtedy, gdy zmieniły się ustawienia kodu kreskowego lub jeśli zmienił się adres URL Staffingly. Kody kreskowe zostaną wygenerowane ponownie przy następnym dostępie.',
