...
return [
    ...
    'ldap_activated_flag_help'  => 'Bu değer, senkronize edilmiş bir kullanıcının Staffingly\'de oturum açıp açamayacağını belirlemek için kullanılır. Girdiğiniz değer AD/LDAP tarafındaki Attribute ismi ile aynı olmamalı. Bu alana girdiğiniz değer AD/LDAP üzerinde yok ise veya değeri 0 ise kullanıcı girişi devre dışı kalacaktır. Eğer Attribute değeri 1, true yada başka bir metin ise kullanıcı girişine izin verilecektir. Eğer Attribute değeri boş bırakılmış ve kullanıcı askıya alınmamış ise userAccountControl ayarı esas alınacaktır.',
    ...
    'load_remote_help_text'		=> 'Yükleme dış internetten komut dosyalarını yükleyemiyorsa bu kutunun işaretini kaldırın. Bu, Staffingly\'nin Gravatar veya diğer dış kaynaklardan avatarları yüklemeye çalışmasını engeller.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Burada bir URL verilirse, kullanıcı Staffingly oturumunu kapattıktan sonra kullanıcılar bu URL\'ye yönlendirilir. Bu, Kimlik Doğrulama sağlayıcınızın kullanıcı oturumlarını doğru bir şekilde kapatmak için kullanışlıdır.',
    ...
    'show_images_in_email_help'   => 'Staffingly kurulumunuz bir VPN\'in ya da kapalı bir ağın arkasındaysa ve ağ dışındaki kullanıcılar bu kurulumda sunulan görüntüleri e-postalarına yükleyemezse bu kutunun işaretini kaldırın.',
    'site_name'                 => 'Site Adı',
...
<a href=":webhook_link" target="_new" rel="noopener">gelen bir webhook oluştur</a>:app hesabınızda. Tıkla<strong>Test :app Entegrasyonu</strong>Kaydetmeden önce ayarlarınızın doğru olduğunu onaylamak için düğmesine basın. ',
    ...
    'support_footer_help'       => 'Staffingly destek, bilgi ve Kullanıcı Kılavuzu linklerini kimin göreceğini seçin',
    'version_footer'            => 'Altbilgi içinde Sürüm ',
    'version_footer_help'       => 'Staffingly sürümünü kimin göreceğini ve yapı numarasını belirleyin.',
    ...
    'width_w'        => 'g',
    'height_h'        => 'y',
    'show_url_in_emails'                => 'E-postalardaki Staffingly\'ye bağlantı',
    'show_url_in_emails_help_text'      => 'E-posta altbilgilerinizdeki Staffingly kurulumuna geri dönmek istemiyorsanız, bu kutuyu kaldırın. Kullanıcılarınızın çoğu hiç giriş yapmazsa kullanışlıdır.',
    'text_pt'        => 'dpi',
    ...
    'barcodes_help' => 'Bu, önbelleğe alınmış barkodları silmeyi dener. Bu, genellikle yalnızca barkod ayarlarınız değiştiyse veya Staffingly URL\'niz değiştiyse kullanılır. Bir sonraki erişimde barkodlar yeniden oluşturulacaktır.',
