...
return [
    ...
    'importing_help'        => 'CSV failas turėtų būti atskirtas kableliais ir suformatuotas su antraštėmis, kurios atitiktų <a href="https://staffingly.readme.io/docs/importing" target="_new">pavyzdinių CSV failų dokumentacijoje <i class="fa fa-external-link"></i></a> antraštes.',
    ...
    'webhook_test_msg'        => 'Oh hai! Panašu jog jūsų :app integracija su Staffingly veikia!',
    ...
    'footer_credit' => '<a target="_blank" href="https://staffinglyapp.com" rel="noopener">Staffingly</a> yra atvirojo kodo programinė įranga, kurią su <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">meile</span> sukūrė Grokability, Inc.',
