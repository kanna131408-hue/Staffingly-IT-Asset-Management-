...
return [
    ...
    'importing'         	=> 'الاستيراد',
    'importing_help'        => 'The CSV should be comma-delimited and formatted with headers that match the ones in the <a href="https://staffingly.readme.io/docs/importing" target="_new">sample CSVs in the documentation <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg'        => 'مرحبًا! أخبار سعيدة ، يبدو أن نظامك الأن يعمل مع Staffingly ',
    ...
    'show_or_hide_eulas' => 'مرحبًا! أخبار سعيدة ، يبدو أن نظامك الأن يعمل مع Staffingly. ',
    'supplier'              => 'المورد',
    'suppliers'  			=> 'الموردون',
    ...
    'footer_credit' => '<a target="_blank" href="https://staffinglyapp.com" rel="noopener">Staffingly</a> is open source software, made with <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">love</span> by Grokability, Inc.',
