...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('img/sly favicon.ico') }}">
...
<body>
    ...
    @php
        $count = 0;
    @endphp
    {{-- If we are rendering multiple users we'll add the ability to show/hide EULAs for all of them at once via this
    button --}}
    @if (count($users) > 1)
    ...
    @foreach ($users as $show_user)
        ...
        @if ($show_user->assets->count() > 0)
            ...
            <table class="snipe-table table table-striped inventory" id="AssetsAssigned" data-pagination="false"
                ...
                data-toolbar="#assets-toolbar" data-sort-order="desc" data-sort-name="created_at" data-show-columns="true"
                ...
                <thead>
                    ...
                    <th data-field="asset_category" data-sortable="true" data-visible="true">{{ trans('general.category') }}
                    </th>
                    ...
                    <th data-field="asset_location" data-sortable="true" data-visible="false">{{ trans('general.location') }}
                    </th>
        ...
        @if ($show_user->licenses->count() > 0)
            ...
            <table class="snipe-table table table-striped inventory" id="licensessAssigned" data-toolbar="#licenses-toolbar"
                data-pagination="false" data-id-table="licensessAssigned" data-search="false" data-side-pagination="client"
                data-sortable="true" data-sort-order="desc" data-sort-name="created_at" data-show-columns="true"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="signature" data-sortable="false" data-visible="true">{{ trans('general.signature') }}
                        </th>
                    </tr>
                </thead>
                @php
            ...
            <table class="snipe-table table table-striped inventory" id="accessoriesAssigned"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="accessory_image" data-sortable="true" data-visible="true">{{ trans('general.image') }}
                        </th>
        ...
        @if ($show_user->consumables->count() > 0)
            ...
            <table class="snipe-table table table-striped inventory" id="consumablesAssigned" data-pagination="false"
                ...
                data-side-pagination="client" data-sortable="true" data-sort-order="desc" data-sort-name="created_at"
                data-show-columns="true" data-cookie-id-table="consumablesAssigned">
                <thead>
                    <tr>
                        <th style="width: 20px;" data-sortable="false" data-switchable="false"></th>
                        <th style="width: 40%;" data-sortable="true" data-switchable="false">{{ trans('general.name') }}</th>
        ...
        @if (count($users) === 1 && !empty($eulas))
            ...
            <div class="pull-right">
                <button class="btn btn-default hidden-print" type="button" data-toggle="collapse" data-target=".eula-row"
                    aria-expanded="false" aria-controls="eula-row" title="EULAs">
                    <i class="fa fa-eye-slash"></i>
                </button>
            </div>
