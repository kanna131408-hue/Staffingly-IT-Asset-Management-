<?php
/*! \mainpage Staffingly Code Documentation
 *
 * \section intro_sec Introduction
 *
 * This documentation is designed to allow developers to easily understand
 * the backend code of Staffingly. Familiarity with the PHP language is assumed,
 ...
 * [Installation documentation](https://staffingly.readme.io) for
 * information on how to install Staffingly.
 *
 * To learn how to set up a development environment and get started developing for Staffingly,
 * please see the [contributing documentation](https://staffingly.readme.io/docs/contributing-overview).
 *
 * Only the Staffingly specific controllers, models, helpers, service providers,
