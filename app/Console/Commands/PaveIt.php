...
class PaveIt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'staffingly:pave  {--force : Skip the interactive yes/no prompt for confirmation}';
