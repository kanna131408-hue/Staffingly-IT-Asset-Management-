...
class FixDoubleEscape extends Command
{
     ...
     * @var string
     */
    protected $signature = 'staffingly:unescape';
     ...
     * @var string
     */
    protected $description = 'This should be run to fix some double-escaping issues from earlier versions of Staffingly.';
